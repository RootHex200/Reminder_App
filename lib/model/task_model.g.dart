...
void _taskModelSerialize(
  ...
  writer.writeString(offsets[0], object.colors);
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> colorsEqualTo(
    String value, {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> colorsGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> colorsLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> colorsBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> colorsStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> colorsEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> colorsContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> colorsMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> colorsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'colors',
        value: '',
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> colorsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'colors',
        value: '',
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByColors() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colors', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByColorsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colors', Sort.desc);
    });
  }
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByColors() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colors', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByColorsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colors', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByColors(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'colors', caseSensitive: caseSensitive);
    });
  }
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, String, QQueryOperations> colorsProperty() {
    return QueryBuilder.apply(this, (query) {
